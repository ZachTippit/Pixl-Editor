// NOTE 9/6!!! This go file will be broken as there is not a PxCanvasRenderer created yet.
// PxCanvas relies on the renderrer, hence several variables here are underlined until that is done.
